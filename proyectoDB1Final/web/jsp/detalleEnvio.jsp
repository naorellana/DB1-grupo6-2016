<%-- 
    Document   : entregas
    Created on : 30-sep-2016, 12:19:32
...
<html>
	...
	<link href='https://fonts.googleapis.com/css?family=Cabin+Sketch' rel='stylesheet' type='text/css'>
        <title>| Detalle De Envios | Bases de Datos 1 | 2016 | Grupo No. 6 Seccion "A"</title>
    </head>
    <body class="fondo fuente">
        ...
        <div class="col-md-6 center-block quitar-float text-center   fuente"> 
                ...
                <p class="Cabin-Sketch blanco"> Detalle Envios </p>
                <form action="#" method="post">
                    <p><input type="text" name="idDetalleEnvio" id="idDetalleEnvio" placeholder="idDetalleEnvio"> </p>
                    <p><input type="text" name="fechaEnvio" id="fechaEnvio" placeholder="fechaEnvio"> </p>
