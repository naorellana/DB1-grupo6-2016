 ...
 */
import java.sql.*;
public class conexionSqlPrueba {
    ...
    public Object [][] consultarDB1(String nombreTabla){
        ...
        return registro; // retorna un objeto con los datos y al llamarlo desde otra clase un bbjeto sera = conexionSqlPrueba.consultarDB1
