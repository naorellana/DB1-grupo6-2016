 ...
 */
public class pruebasFactura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sql="INSERT INTO FACTURA (NUMEROFACTURA, FECHA, CLIENTE, DIRECCION, PRODUCTOS  )  VALUES  ( "+ numeroFactura +", '"+fecha+"', '"+cliente+"', '"+direccion +"', '"+ productos+"')";
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet pruebaVEHICULO</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet pruebaVEHICULO at " + request.getContextPath() + "</h1>");
