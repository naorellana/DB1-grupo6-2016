 ...
 */
public class TipoPaquete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sql="INSERT INTO ID_TIPO_PAQUETE ( ID_TIPO_PAQUETE, TIPO_PAQUETE, LARGO, ANCHO, PROFUNDIDA, PESO ) VALUES (";  //pegar cadena de insert hasta values *ideal para sqdl developer*
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TipoPaquete</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<h1>Servlet TipoPaquete at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
