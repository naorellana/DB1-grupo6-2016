...
<html>
    ...
    <body class="fondo fuente">
        ...
        <div class="col-md-6 center-block quitar-float text-center   fuente"> 
                ...
                <form action="pruebasEmpleados" method="post">
                    <p><input type="text" name="id_empleado" id="id_empleado" placeholder="id_empleado"> </p>
                    <p><input type="text" name="nombre" id="nombre" placeholder="nombre"> </p>
                    <p><input type="text" name="licencia" id="licencia" placeholder="licencia"> </p>
