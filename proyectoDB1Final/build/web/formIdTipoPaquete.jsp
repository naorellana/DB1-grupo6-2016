    ...
    <body class="fondo fuente">
        ...
        <div class="col-md-6 center-block quitar-float text-center   fuente"> 
                ...
                <form action="formularioIdTipoPaquete" method="post">
                    <p><input type="text" name="ID_TIPO_PAQUETE" id="ID_TIPO_PAQUETE" placeholder="ID_TIPO_PAQUETE" value="<%=ID_TIPO_PAQUETE%>">  </p>
                    <p><input type="text" name="TIPO_PAQUETE" id="TIPO_PAQUETE" placeholder="TIPO_PAQUETE" value="<%=TIPO_PAQUETE%>" > </p>
                    <p><input type="text" name="LARGO" id="LARGO" placeholder="LARGO" value="<%=LARGO%>" >  </p>
                    <p><input type="text" name="ANCHO" id="ANCHO" placeholder="ANCHO" value="<%=ANCHO%>" > </p>
                    <p><input type="text" name="PROFUNDIDA" id="PROFUNDIDA" placeholder="PROFUNDIDA" value="<%=PROFUNDIDA%>" > </p>
                    <p><input type="text" name="PESO" id="PESO" placeholder="PESO" value="<%=PESO%>" > </p>
